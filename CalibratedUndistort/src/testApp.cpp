...
void testApp::setup() {	
	...
	cout << "fov: " << endl << calib.getDistortedIntrinsics().getFov() << endl;
	//cout << "sensor size: " << endl << calib.getDistortedIntrinsics().getSensorSize() << endl;
	cout << "focal length: " << endl << calib.getDistortedIntrinsics().getFocalLength() << endl;
